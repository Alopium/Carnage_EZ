...
Auton("BLUE NEGATIVE MATCH",bluenm),
Auton("RED NEGATIVE MATCH",rednm), 
Auton("BLUE POSITIVE TOURNAMENT",bluept),
Auton("RED POSITIVE TOURNAMENT",redpt),
Auton("BLUE NEGATIVE TOURNAMENT",bluent),
Auton("RED NEGATIVE TOURNAMENT",rednt), 
Auton("SKILLS",skills),
...
void opcontrol() {
  ...
  while (true) {
    ...
    doink.button_toggle(master.get_digital_new_press(pros::E_CONTROLLER_DIGITAL_DOWN));
    
  if (master.get_digital_new_press(pros::E_CONTROLLER_DIGITAL_RIGHT)){
            liftPID.target_set(310);
    };
