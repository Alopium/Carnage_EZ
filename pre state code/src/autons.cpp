...
void default_constants() {
  // P, I, D, and Start I
  chassis.pid_drive_constants_set(30, 0.4 , 300);   //310      // Fwd/rev constants, used for odom and non odom motions
...
void redpm(){
  clamps.set(true);
  chassis.pid_drive_set(-26, 56, true);
  chassis.pid_wait();
  pros::delay(400);
  clamps.set(false);
  pros::delay(200);
  chassis.pid_turn_set(-75,110, true);
  chassis.pid_wait();
  setIntake(-127);
  ...
  chassis.pid_wait();
  setIntake(0);
  chassis.pid_drive_set(34.5, 110, true);
  chassis.pid_wait();
  doinkr.set(true);
  pros::delay(400);
  chassis.pid_turn_set(126, 110, true);
  chassis.pid_wait();
  doinkr .set(false);
  pros::delay(400);
  ...
  chassis.pid_wait();
  chassis.pid_turn_set(140, 110, true);
  chassis.pid_wait();
...
void bluepm(){
  ...
  chassis.pid_wait();
  pros::delay(500);
  chassis.pid_turn_set(-95, 90, true);
  chassis.pid_wait();
  setIntake(0);
  chassis.pid_drive_set(34.8, 110, true);
  chassis.pid_wait();
  doinkr.set(true);
  pros::delay(400);
  chassis.pid_turn_set(-118, 127, true);
  chassis.pid_wait();
  doinkr.set(false);
  pros::delay(400);
  chassis.pid_turn_set(-126, 110);
  setIntake(-127);
  chassis.pid_wait();
  chassis.pid_drive_set(13, 110, true);
  chassis.pid_wait();
  pros::delay(400);
  chassis.pid_drive_set(-9,110);
  chassis.pid_wait();
...
//  chassis.odom_y_flip(true);
  ...
  chassis.pid_wait();
  chassis.pid_drive_set(-7.5,110,false);
  chassis.pid_wait();
  setIntake(-127);
  pros::delay(400);
  clamps.set(true);
...
void ringrb(){
  clamps.set(true);
  chassis.pid_drive_set(-24.5, 56, true);
  chassis.pid_wait();
  pros::delay(400);
  clamps.set(false);
  pros::delay(200);
  chassis.pid_turn_set(-121, 100);
  chassis.pid_wait();
  setIntake(-127);
  pros::delay(400);
  chassis.pid_drive_set(22, 90, true);
  chassis.pid_wait();
  chassis.pid_turn_set(-64, 90);
  chassis.pid_wait();
  pros::delay(200);
  chassis.pid_drive_set(12, 100, true);
  chassis.pid_wait();
  chassis.pid_turn_set(29, 110);
  chassis.pid_wait();
  chassis.pid_drive_set(20, 110, true);
  chassis.pid_wait();
  chassis.pid_turn_set(160, 110);
  chassis.pid_wait();
  liftPID.target_set(1400);
...
void goalrb(){
  chassis.pid_drive_constants_set(30, 0.4, 225);
  doinkr.set(true);
  doinkrc.set(false);
    chassis.pid_drive_set(40, 86, true);
  pros::delay(1050);
  doinkrc.set(true);
  pros::delay(200);
  chassis.pid_drive_set(-10, 120, true);
  chassis.pid_wait();
  doinkrc.set(false);
  pros::delay(200);
  chassis.pid_drive_set(-3,110, false);
  chassis.pid_wait();
  doinkr.set(false);
  pros::delay(400);
  chassis.pid_turn_set(-164, 50);
  chassis.pid_wait();
  clamps.set(true);
  chassis.pid_drive_set(-16, 60);
  chassis.pid_wait();
  pros::delay(250);
  clamps.set(false);
  pros::delay(250);
